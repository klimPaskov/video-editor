# Three-Gate Review Checklist

## Gate 1: plan approval

- [ ] Source, transcript, policy, edit plan, effect plan, and asset hashes are current.
...
- [ ] Every logical segment has a preview and contact sheet.
...
- [ ] Approved segment revisions are assembled.
- [ ] Final loudness and A/V synchronization pass.
- [ ] Final output fully decodes.
- [ ] A complete watch-through or approved equivalent review is recorded.
- [ ] Asset provenance and licence records are complete.
- [ ] Caption sidecars, transcript, chapters, and delivery metadata are present.
- [ ] Approval binds to the final preview, QA report, plan, asset manifest, composition bundle, and delivery profile hashes.
- [ ] Backup destinations are configured before delivery cleanup.
